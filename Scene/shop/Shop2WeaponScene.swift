// 街画面
import SpriteKit
class Shop2WeaponScene: BaseScene {
    ...
    override func checkTochEvent(name: String) {
        if name == "hatena_habel" {
            ...
            showAlert(WeaponSetting.getName("shoes"), text: WeaponSetting.getExplain("golden"), ok_text: "そうなんだー")
        } else if name == "hatena_bringer" {
            showAlert(WeaponSetting.getName("bringer"), text: WeaponSetting.getExplain("bringer"), ok_text: "すげえ")
        } else if name == "buy_habel" {
            _buy_name = "habel"
            buyConfirm()
        } else if name == "buy_kabuto" {
            _buy_name = "kabuto"
            buyConfirm()
        } else if name == "buy_golden" {
            _buy_name = "golden"
            buyConfirm()
        } else if name == "buy_bringer" {
            _buy_name = "bringer"
            buyConfirm()
        } else if name == "back" {
            goShopScene()
